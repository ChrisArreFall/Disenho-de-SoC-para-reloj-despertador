...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../alarm.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x490c0
SOPC_SYSID_FLAG += --sidp=0x490c0
ELF_PATCH_FLAG  += --sidp 0x490c0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1571307407
SOPC_SYSID_FLAG += --timestamp=1571307407
ELF_PATCH_FLAG  += --timestamp 1571307407
