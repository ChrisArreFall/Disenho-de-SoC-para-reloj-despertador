...
`timescale 1 ps / 1 ps
module alarm_mm_interconnect_0 (
		...
		output wire [31:0] HOURS_s1_writedata,                    //                                .writedata
		output wire        HOURS_s1_chipselect,                   //                                .chipselect
		...
		output wire [1:0]  MINUTES_s1_address,                    //                      MINUTES_s1.address
		output wire        MINUTES_s1_write,                      //                                .write
		input  wire [31:0] MINUTES_s1_readdata,                   //                                .readdata
		output wire [31:0] MINUTES_s1_writedata,                  //                                .writedata
		output wire        MINUTES_s1_chipselect,                 //                                .chipselect
		...
		output wire [1:0]  SECONDS_s1_address,                    //                      SECONDS_s1.address
		output wire        SECONDS_s1_write,                      //                                .write
		input  wire [31:0] SECONDS_s1_readdata,                   //                                .readdata
		output wire [31:0] SECONDS_s1_writedata,                  //                                .writedata
		output wire        SECONDS_s1_chipselect,                 //                                .chipselect
	...
	wire  [18:0] uart_avalon_rs232_slave_agent_m0_address;                                  // UART_avalon_rs232_slave_agent:m0_address -> UART_avalon_rs232_slave_translator:uav_address
	...
	wire  [97:0] uart_avalon_rs232_slave_agent_rf_source_data;                              // UART_avalon_rs232_slave_agent:rf_source_data -> UART_avalon_rs232_slave_agent_rsp_fifo:in_data
	...
	wire  [97:0] uart_avalon_rs232_slave_agent_rsp_fifo_out_data;                           // UART_avalon_rs232_slave_agent_rsp_fifo:out_data -> UART_avalon_rs232_slave_agent:rf_sink_data
	...
	wire  [96:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> UART_avalon_rs232_slave_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // UART_avalon_rs232_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire  [13:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> UART_avalon_rs232_slave_agent:cp_channel
	...
	wire  [96:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> SysID_control_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                     // SysID_control_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire  [13:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> SysID_control_slave_agent:cp_channel
	...
	wire  [13:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> RAM_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> ROM_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // ROM_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire  [13:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> ROM_s1_agent:cp_channel
	...
	wire  [96:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> BUTTONS_s1_agent:cp_data
	...
	wire  [96:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> LEDs_s1_agent:cp_data
	...
	wire  [18:0] seconds_s1_agent_m0_address;                                               // SECONDS_s1_agent:m0_address -> SECONDS_s1_translator:uav_address
	wire   [3:0] seconds_s1_agent_m0_byteenable;                                            // SECONDS_s1_agent:m0_byteenable -> SECONDS_s1_translator:uav_byteenable
	wire         seconds_s1_agent_m0_read;                                                  // SECONDS_s1_agent:m0_read -> SECONDS_s1_translator:uav_read
	wire         seconds_s1_agent_m0_readdatavalid;                                         // SECONDS_s1_translator:uav_readdatavalid -> SECONDS_s1_agent:m0_readdatavalid
	wire         seconds_s1_agent_m0_lock;                                                  // SECONDS_s1_agent:m0_lock -> SECONDS_s1_translator:uav_lock
	wire  [31:0] seconds_s1_agent_m0_writedata;                                             // SECONDS_s1_agent:m0_writedata -> SECONDS_s1_translator:uav_writedata
	wire         seconds_s1_agent_m0_write;                                                 // SECONDS_s1_agent:m0_write -> SECONDS_s1_translator:uav_write
	wire   [2:0] seconds_s1_agent_m0_burstcount;                                            // SECONDS_s1_agent:m0_burstcount -> SECONDS_s1_translator:uav_burstcount
	wire         seconds_s1_agent_rf_source_valid;                                          // SECONDS_s1_agent:rf_source_valid -> SECONDS_s1_agent_rsp_fifo:in_valid
	wire  [97:0] seconds_s1_agent_rf_source_data;                                           // SECONDS_s1_agent:rf_source_data -> SECONDS_s1_agent_rsp_fifo:in_data
	wire         seconds_s1_agent_rf_source_ready;                                          // SECONDS_s1_agent_rsp_fifo:in_ready -> SECONDS_s1_agent:rf_source_ready
	wire         seconds_s1_agent_rf_source_startofpacket;                                  // SECONDS_s1_agent:rf_source_startofpacket -> SECONDS_s1_agent_rsp_fifo:in_startofpacket
	wire         seconds_s1_agent_rf_source_endofpacket;                                    // SECONDS_s1_agent:rf_source_endofpacket -> SECONDS_s1_agent_rsp_fifo:in_endofpacket
	wire         seconds_s1_agent_rsp_fifo_out_valid;                                       // SECONDS_s1_agent_rsp_fifo:out_valid -> SECONDS_s1_agent:rf_sink_valid
	wire  [97:0] seconds_s1_agent_rsp_fifo_out_data;                                        // SECONDS_s1_agent_rsp_fifo:out_data -> SECONDS_s1_agent:rf_sink_data
	...
	wire  [18:0] minutes_s1_agent_m0_address;                                               // MINUTES_s1_agent:m0_address -> MINUTES_s1_translator:uav_address
	wire   [3:0] minutes_s1_agent_m0_byteenable;                                            // MINUTES_s1_agent:m0_byteenable -> MINUTES_s1_translator:uav_byteenable
	wire         minutes_s1_agent_m0_read;                                                  // MINUTES_s1_agent:m0_read -> MINUTES_s1_translator:uav_read
	wire         minutes_s1_agent_m0_readdatavalid;                                         // MINUTES_s1_translator:uav_readdatavalid -> MINUTES_s1_agent:m0_readdatavalid
	wire         minutes_s1_agent_m0_lock;                                                  // MINUTES_s1_agent:m0_lock -> MINUTES_s1_translator:uav_lock
	wire  [31:0] minutes_s1_agent_m0_writedata;                                             // MINUTES_s1_agent:m0_writedata -> MINUTES_s1_translator:uav_writedata
	wire         minutes_s1_agent_m0_write;                                                 // MINUTES_s1_agent:m0_write -> MINUTES_s1_translator:uav_write
	wire   [2:0] minutes_s1_agent_m0_burstcount;                                            // MINUTES_s1_agent:m0_burstcount -> MINUTES_s1_translator:uav_burstcount
	wire         minutes_s1_agent_rf_source_valid;                                          // MINUTES_s1_agent:rf_source_valid -> MINUTES_s1_agent_rsp_fifo:in_valid
	wire  [97:0] minutes_s1_agent_rf_source_data;                                           // MINUTES_s1_agent:rf_source_data -> MINUTES_s1_agent_rsp_fifo:in_data
	wire         minutes_s1_agent_rf_source_ready;                                          // MINUTES_s1_agent_rsp_fifo:in_ready -> MINUTES_s1_agent:rf_source_ready
	wire         minutes_s1_agent_rf_source_startofpacket;                                  // MINUTES_s1_agent:rf_source_startofpacket -> MINUTES_s1_agent_rsp_fifo:in_startofpacket
	wire         minutes_s1_agent_rf_source_endofpacket;                                    // MINUTES_s1_agent:rf_source_endofpacket -> MINUTES_s1_agent_rsp_fifo:in_endofpacket
	wire         minutes_s1_agent_rsp_fifo_out_valid;                                       // MINUTES_s1_agent_rsp_fifo:out_valid -> MINUTES_s1_agent:rf_sink_valid
	wire  [97:0] minutes_s1_agent_rsp_fifo_out_data;                                        // MINUTES_s1_agent_rsp_fifo:out_data -> MINUTES_s1_agent:rf_sink_data
	...
	wire  [18:0] hours_s1_agent_m0_address;                                                 // HOURS_s1_agent:m0_address -> HOURS_s1_translator:uav_address
	wire   [3:0] hours_s1_agent_m0_byteenable;                                              // HOURS_s1_agent:m0_byteenable -> HOURS_s1_translator:uav_byteenable
	wire         hours_s1_agent_m0_read;                                                    // HOURS_s1_agent:m0_read -> HOURS_s1_translator:uav_read
	wire         hours_s1_agent_m0_readdatavalid;                                           // HOURS_s1_translator:uav_readdatavalid -> HOURS_s1_agent:m0_readdatavalid
	wire         hours_s1_agent_m0_lock;                                                    // HOURS_s1_agent:m0_lock -> HOURS_s1_translator:uav_lock
	wire  [31:0] hours_s1_agent_m0_writedata;                                               // HOURS_s1_agent:m0_writedata -> HOURS_s1_translator:uav_writedata
	wire         hours_s1_agent_m0_write;                                                   // HOURS_s1_agent:m0_write -> HOURS_s1_translator:uav_write
	wire   [2:0] hours_s1_agent_m0_burstcount;                                              // HOURS_s1_agent:m0_burstcount -> HOURS_s1_translator:uav_burstcount
	wire         hours_s1_agent_rf_source_valid;                                            // HOURS_s1_agent:rf_source_valid -> HOURS_s1_agent_rsp_fifo:in_valid
	wire  [97:0] hours_s1_agent_rf_source_data;                                             // HOURS_s1_agent:rf_source_data -> HOURS_s1_agent_rsp_fifo:in_data
	wire         hours_s1_agent_rf_source_ready;                                            // HOURS_s1_agent_rsp_fifo:in_ready -> HOURS_s1_agent:rf_source_ready
	wire         hours_s1_agent_rf_source_startofpacket;                                    // HOURS_s1_agent:rf_source_startofpacket -> HOURS_s1_agent_rsp_fifo:in_startofpacket
	wire         hours_s1_agent_rf_source_endofpacket;                                      // HOURS_s1_agent:rf_source_endofpacket -> HOURS_s1_agent_rsp_fifo:in_endofpacket
	wire         hours_s1_agent_rsp_fifo_out_valid;                                         // HOURS_s1_agent_rsp_fifo:out_valid -> HOURS_s1_agent:rf_sink_valid
	wire  [97:0] hours_s1_agent_rsp_fifo_out_data;                                          // HOURS_s1_agent_rsp_fifo:out_data -> HOURS_s1_agent:rf_sink_data
	...
	wire  [18:0] timercore_s1_agent_m0_address;                                             // TimerCore_s1_agent:m0_address -> TimerCore_s1_translator:uav_address
	...
	wire  [97:0] timercore_s1_agent_rf_source_data;                                         // TimerCore_s1_agent:rf_source_data -> TimerCore_s1_agent_rsp_fifo:in_data
	...
	wire  [97:0] timercore_s1_agent_rsp_fifo_out_data;                                      // TimerCore_s1_agent_rsp_fifo:out_data -> TimerCore_s1_agent:rf_sink_data
	...
	wire  [96:0] uart_avalon_rs232_slave_agent_rp_data;                                     // UART_avalon_rs232_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [96:0] sysid_control_slave_agent_rp_data;                                         // SysID_control_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [96:0] rom_s1_agent_rp_data;                                                      // ROM_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [96:0] buttons_s1_agent_rp_data;                                                  // BUTTONS_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [96:0] leds_s1_agent_rp_data;                                                     // LEDs_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [96:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_003:sink1_data
	...
	wire  [96:0] cmd_demux_001_src3_data;                                                   // cmd_demux_001:src3_data -> cmd_mux_005:sink1_data
	...
	wire  [96:0] rsp_demux_003_src1_data;                                                   // rsp_demux_003:src1_data -> rsp_mux_001:sink2_data
	...
	wire  [96:0] rsp_demux_005_src1_data;                                                   // rsp_demux_005:src1_data -> rsp_mux_001:sink3_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (CLK_clk_clk),                           //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (seconds_s1_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (seconds_s1_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (seconds_s1_agent_m0_read),              //                         .read
		.uav_write              (seconds_s1_agent_m0_write),             //                         .write
		.uav_waitrequest        (seconds_s1_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (seconds_s1_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (seconds_s1_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (seconds_s1_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (seconds_s1_agent_m0_writedata),         //                         .writedata
		.uav_lock               (seconds_s1_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (seconds_s1_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (SECONDS_s1_address),                    //      avalon_anti_slave_0.address
		.av_write               (SECONDS_s1_write),                      //                         .write
		.av_readdata            (SECONDS_s1_readdata),                   //                         .readdata
		.av_writedata           (SECONDS_s1_writedata),                  //                         .writedata
		.av_chipselect          (SECONDS_s1_chipselect),                 //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) minutes_s1_translator (
		.clk                    (CLK_clk_clk),                           //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (minutes_s1_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (minutes_s1_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (minutes_s1_agent_m0_read),              //                         .read
		.uav_write              (minutes_s1_agent_m0_write),             //                         .write
		.uav_waitrequest        (minutes_s1_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (minutes_s1_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (minutes_s1_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (minutes_s1_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (minutes_s1_agent_m0_writedata),         //                         .writedata
		.uav_lock               (minutes_s1_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (minutes_s1_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (MINUTES_s1_address),                    //      avalon_anti_slave_0.address
		.av_write               (MINUTES_s1_write),                      //                         .write
		.av_readdata            (MINUTES_s1_readdata),                   //                         .readdata
		.av_writedata           (MINUTES_s1_writedata),                  //                         .writedata
		.av_chipselect          (MINUTES_s1_chipselect),                 //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (CLK_clk_clk),                           //                      clk.clk
		.reset                  (CPU_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (hours_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (hours_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (hours_s1_agent_m0_read),                //                         .read
		.uav_write              (hours_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (hours_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (hours_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (hours_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (hours_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (hours_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (hours_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (hours_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (HOURS_s1_address),                      //      avalon_anti_slave_0.address
		.av_write               (HOURS_s1_write),                        //                         .write
		.av_readdata            (HOURS_s1_readdata),                     //                         .readdata
		.av_writedata           (HOURS_s1_writedata),                    //                         .writedata
		.av_chipselect          (HOURS_s1_chipselect),                   //                         .chipselect
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (CLK_clk_clk),                                 //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (seconds_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (seconds_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (seconds_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (seconds_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (seconds_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (seconds_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (seconds_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (seconds_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (seconds_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (seconds_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (seconds_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (seconds_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (seconds_s1_agent_rp_ready),                   //                .ready
		...
		.rf_sink_endofpacket     (seconds_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (seconds_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (seconds_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (seconds_s1_agent_rf_source_valid),            //                .valid
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) seconds_s1_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                                 //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (seconds_s1_agent_rf_source_data),             //        in.data
		.in_valid          (seconds_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (seconds_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (seconds_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (seconds_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (seconds_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (seconds_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (seconds_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (seconds_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (seconds_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (CLK_clk_clk),                                 //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (minutes_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (minutes_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (minutes_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (minutes_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (minutes_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (minutes_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (minutes_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (minutes_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (minutes_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (minutes_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (minutes_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (minutes_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (minutes_s1_agent_rp_ready),                   //                .ready
		...
		.rf_sink_endofpacket     (minutes_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (minutes_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (minutes_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (minutes_s1_agent_rf_source_valid),            //                .valid
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) minutes_s1_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                                 //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (minutes_s1_agent_rf_source_data),             //        in.data
		.in_valid          (minutes_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (minutes_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (minutes_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (minutes_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (minutes_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (minutes_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (minutes_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (minutes_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (minutes_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (CLK_clk_clk),                               //             clk.clk
		.reset                   (CPU_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (hours_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (hours_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (hours_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (hours_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (hours_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (hours_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (hours_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (hours_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (hours_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (hours_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (hours_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (hours_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (hours_s1_agent_rp_ready),                   //                .ready
		...
		.rf_sink_endofpacket     (hours_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (hours_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (hours_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (hours_s1_agent_rf_source_valid),            //                .valid
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) hours_s1_agent_rsp_fifo (
		.clk               (CLK_clk_clk),                               //       clk.clk
		.reset             (CPU_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (hours_s1_agent_rf_source_data),             //        in.data
		.in_valid          (hours_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (hours_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (hours_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (hours_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (hours_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (hours_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (hours_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (hours_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (hours_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	alarm_mm_interconnect_0_router_001 router_001 (
	...
	alarm_mm_interconnect_0_router_002 router_002 (
	...
	alarm_mm_interconnect_0_router_003 router_003 (
	...
	alarm_mm_interconnect_0_router_002 router_004 (
	...
	alarm_mm_interconnect_0_router_002 router_005 (
	...
	alarm_mm_interconnect_0_router_003 router_006 (
	...
	alarm_mm_interconnect_0_router_002 router_007 (
	...
	alarm_mm_interconnect_0_router_003 router_008 (
	...
	alarm_mm_interconnect_0_router_003 router_009 (
	...
	alarm_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_006 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_007 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_008 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_009 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_cmd_mux_001 cmd_mux_010 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_004 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_006 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_007 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_008 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_009 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_demux_001 rsp_demux_010 (
		.clk                (CLK_clk_clk),                           //       clk.clk
		.reset              (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                  (CLK_clk_clk),                           //       clk.clk
		.reset                (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	alarm_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (CLK_clk_clk),                           //       clk.clk
		.reset               (CPU_reset_reset_bridge_in_reset_reset), // clk_reset.reset
